...
package com.dot.clock2.dialogs;
...
public final class TimePickerDialogController extends DialogFragmentController<BottomSheetTimePickerDialog> {
    ...
    public void show(int initialHourOfDay, int initialMinute, String tag) {
        ...
        final String numpadStyle = mContext.getString(com.dot.clock2.R.string.number_pad);
        final String gridStyle = mContext.getString(com.dot.clock2.R.string.grid_selector);
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(mContext);
        String prefTimePickerStyle = prefs.getString(mContext.getString(com.dot.clock2.R.string.key_time_picker_style), numpadStyle);
        ...
        if (isNumpadStyle || isGridStyle) {
            final String themeLight = mContext.getString(com.dot.clock2.R.string.theme_light);
            final String themeDark = mContext.getString(com.dot.clock2.R.string.theme_dark);
            final String themeBlack = mContext.getString(com.dot.clock2.R.string.theme_black);
            String prefTheme = prefs.getString(mContext.getString(com.dot.clock2.R.string.key_theme), themeLight);
            
            final int dialogColorRes;
            if (prefTheme.equals(themeLight)) {
                dialogColorRes = com.dot.clock2.R.color.alert_dialog_background_color;
            } else if (prefTheme.equals(themeDark)) {
                dialogColorRes = com.dot.clock2.R.color.alert_dialog_background_color_inverse;
            } else if (prefTheme.equals(themeBlack)) {
                dialogColorRes = com.dot.clock2.R.color.alert_dialog_background_color_black;
            } else {
                dialogColorRes = 0;
            }
            ...
            if (isNumpadStyle) {
                ...
                final int selectedColor = ContextCompat.getColor(mContext, com.dot.clock2.R.color.colorAccent);
