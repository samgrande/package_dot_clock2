...
import com.dot.clock2.data.AsyncDatabaseTableUpdateHandler;
import com.dot.clock2.list.ScrollHandler;
...
public final class AsyncAlarmsTableUpdateHandler extends AsyncDatabaseTableUpdateHandler<Alarm, AlarmsTableManager> {
    ...
    protected void onPostAsyncDelete(Integer result, final Alarm alarm) {
        ...
        if (mSnackbarAnchor != null) {
            ...
            String message = getContext().getString(com.dot.clock2.R.string.snackbar_item_deleted,
                    getContext().getString(com.dot.clock2.R.string.alarm));
            Snackbar.make(mSnackbarAnchor, message, Snackbar.LENGTH_LONG)
                    .setAction(com.dot.clock2.R.string.snackbar_undo_item_deleted, new View.OnClickListener() {
                        @Override
