...
package com.dot.clock2.chronometer;
...
public abstract class ChronometerNotificationService extends Service {
    public static final String ACTION_START_PAUSE = "com.dot.clock2.timers.action.START_PAUSE";
    public static final String ACTION_STOP = "com.dot.clock2.timers.action.STOP";

    public static final String EXTRA_ACTION_ID = "com.dot.clock2.extra.ID";
...
//    }
    ...
    protected final void addStartPauseAction(boolean running, long id) {
        addAction(ACTION_START_PAUSE,
                running ? com.dot.clock2.R.drawable.ic_pause_24dp : com.dot.clock2.R.drawable.ic_start_24dp,
                getString(running ? com.dot.clock2.R.string.pause : com.dot.clock2.R.string.resume),
                id);
    }
    ...
    protected final void addStopAction(long id) {
        addAction(ACTION_STOP, com.dot.clock2.R.drawable.ic_stop_24dp, getString(com.dot.clock2.R.string.stop), id);
    }
