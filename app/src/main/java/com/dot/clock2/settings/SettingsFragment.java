...
public class SettingsFragment extends PreferenceFragment implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(com.dot.clock2.R.xml.preferences);
        // Set ringtone summary
        setSummary(getPreferenceScreen().getSharedPreferences(), getString(com.dot.clock2.R.string.key_timer_ringtone));
        findPreference(getString(com.dot.clock2.R.string.key_alarm_volume))
