...
package com.dot.clock2.settings;
...
public class SettingsActivity extends BaseActivity {
    public static final String EXTRA_THEME_CHANGED = "com.dot.clock2.settings.extra.THEME_CHANGED";
    ...
    protected int layoutResId() {
        return com.dot.clock2.R.layout.activity_settings;
    }
    ...
    private String getSelectedTheme() {
        return mPrefs.getString(getString(com.dot.clock2.R.string.key_theme), "");
    }
