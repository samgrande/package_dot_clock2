...
import com.dot.clock2.alarms.data.AlarmCursor;
import com.dot.clock2.alarms.data.AlarmsListCursorLoader;
import com.dot.clock2.alarms.data.AsyncAlarmsTableUpdateHandler;
...
import com.dot.clock2.util.DelayedSnackbarHandler;
import com.dot.clock2.util.FragmentTagUtils;
import com.philliphsu.bottomsheetpickers.time.BottomSheetTimePickerDialog;

import static com.dot.clock2.util.FragmentTagUtils.makeTag;
...
public class AlarmsFragment extends RecyclerViewFragment<Alarm, BaseAlarmViewHolder, AlarmCursor,
    ...
    public static final String EXTRA_SCROLL_TO_ALARM_ID = "com.dot.clock2.alarms.extra.SCROLL_TO_ALARM_ID";
...
//        }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        mSnackbarAnchor = getActivity().findViewById(com.dot.clock2.R.id.main_content);
    ...
    protected int emptyMessage() {
        return com.dot.clock2.R.string.empty_alarms_container;
    }

    @Override
    protected int emptyIcon() {
        return com.dot.clock2.R.drawable.ic_alarm_96dp;
    }
    ...
    private static String makeTimePickerDialogTag() {
        return FragmentTagUtils.makeTag(AlarmsFragment.class, com.dot.clock2.R.id.fab);
    }
}
