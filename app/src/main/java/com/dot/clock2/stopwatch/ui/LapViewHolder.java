...
public class LapViewHolder extends BaseViewHolder<Lap> {
    ...
    @Bind(com.dot.clock2.R.id.lap_number) TextView mLapNumber;
    @Bind(com.dot.clock2.R.id.elapsed_time) ChronometerWithMillis mElapsedTime;
    @Bind(com.dot.clock2.R.id.total_time) TextView mTotalTime;

    public LapViewHolder(ViewGroup parent) {
        super(parent, com.dot.clock2.R.layout.item_lap, null);
    }
