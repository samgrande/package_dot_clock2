...
package com.dot.clock2.alarms.ui;
...
import com.dot.clock2.alarms.Alarm;
import com.dot.clock2.alarms.misc.AlarmController;
import com.dot.clock2.alarms.misc.AlarmPreferences;
import com.dot.clock2.dialogs.AddLabelDialog;
import com.dot.clock2.dialogs.AddLabelDialogController;
import com.dot.clock2.dialogs.TimePickerDialogController;
import com.dot.clock2.list.BaseViewHolder;
import com.dot.clock2.list.OnListItemInteractionListener;
import com.dot.clock2.timepickers.Utils;
import com.dot.clock2.util.FragmentTagUtils;
import com.dot.clock2.util.TimeFormatUtils;
import com.dot.clock2.util.TimeTextUtils;
...
import static com.dot.clock2.util.TimeFormatUtils.formatTime;
...
public abstract class BaseAlarmViewHolder extends BaseViewHolder<Alarm> {
    ...
    @Bind(com.dot.clock2.R.id.time) TextView mTime;
    @Bind(com.dot.clock2.R.id.on_off_switch) SwitchCompat mSwitch;
    @Bind(com.dot.clock2.R.id.label) TextView mLabel;
    @Bind(com.dot.clock2.R.id.dismiss) Button mDismissButton;
    ...
    public BaseAlarmViewHolder(ViewGroup parent, @LayoutRes int layoutRes,
        ...
        mDismissNowDrawable = ContextCompat.getDrawable(getContext(), com.dot.clock2.R.drawable.ic_dismiss_alarm_24dp);
        mCancelSnoozeDrawable = ContextCompat.getDrawable(getContext(), com.dot.clock2.R.drawable.ic_cancel_snooze);
...
//                        mAlarmController.cancelAlarm(oldAlarm, false);
    ...
    public void onBind(Alarm alarm) {
        ...
        mTimePickerDialogController.tryRestoreCallback(makeTag(com.dot.clock2.R.id.time));
        bindTime(alarm);
    ...
    @OnClick(com.dot.clock2.R.id.dismiss)
    void dismiss() {
    ...
    @OnTouch(com.dot.clock2.R.id.on_off_switch)
...
//    }
    ...
    @OnCheckedChanged(com.dot.clock2.R.id.on_off_switch)
    ...
    @OnClick(com.dot.clock2.R.id.time)
    void openTimePicker() {
        Alarm alarm = getAlarm();
        mTimePickerDialogController.show(alarm.hour(), alarm.minutes(), makeTag(com.dot.clock2.R.id.time));
    }
    ...
    private void bindTime(Alarm alarm) {
        ...
        TextView colorsSource = (TextView) itemView.findViewById(com.dot.clock2.R.id.colors_source);
...
//        int disabled = ContextCompat.getColor(getContext(), R.color.text_color_disabled_light);
    ...
    private void bindDismissButton(Alarm alarm) {
        ...
        String buttonText = snoozed
                ? getContext().getString(com.dot.clock2.R.string.title_snoozing_until, TimeFormatUtils.formatTime(getContext(), alarm.snoozingUntil()))
                : getContext().getString(com.dot.clock2.R.string.dismiss_now);
