...
public class UpcomingAlarmReceiver extends BroadcastReceiver {
    ...
    private static final String ACTION_DISMISS_NOW = "com.dot.clock2.action.DISMISS_NOW";

    public static final String ACTION_CANCEL_NOTIFICATION = "com.dot.clock2.action.CANCEL_NOTIFICATION";
    public static final String ACTION_SHOW_SNOOZING = "com.dot.clock2.action.SHOW_SNOOZING";
    public static final String EXTRA_ALARM = "com.dot.clock2.extra.ALARM";
    ...
    public void onReceive(final Context context, final Intent intent) {
        ...
        if (intent.getAction() == null || actionShowSnoozing) {
            ...
            if (actionShowSnoozing) {
                ...
                title = alarm.label().isEmpty() ? context.getString(com.dot.clock2.R.string.alarm) : alarm.label();
                text = context.getString(com.dot.clock2.R.string.title_snoozing_until,
                        TimeFormatUtils.formatTime(context, alarm.snoozingUntil()));
            } else {
                // No intent action required for default behavior
                title = context.getString(com.dot.clock2.R.string.upcoming_alarm);
            ...
            Notification note = new NotificationCompat.Builder(context)
                    .setSmallIcon(com.dot.clock2.R.drawable.ic_alarm_24dp)
                    .setContentTitle(title)
                    .setContentText(text)
                    .setContentIntent(ContentIntentUtils.create(context,
                            MainActivity.PAGE_ALARMS, id))
                    .addAction(com.dot.clock2.R.drawable.ic_dismiss_alarm_24dp,
                            context.getString(com.dot.clock2.R.string.dismiss_now), piDismiss)
                    .build();
