...
package com.dot.clock2.ringtone.playback;
...
public class AlarmRingtoneService extends RingtoneService<Alarm> {
    ...
    private static final String ACTION_SNOOZE = "com.dot.clock2.ringtone.action.SNOOZE";
    private static final String ACTION_DISMISS = "com.dot.clock2.ringtone.action.DISMISS";
